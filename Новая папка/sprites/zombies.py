...
class ZM:
    ...
    @classmethod
    def create_zombie(cls, type_: str) -> None:
...
class Zombie_1(BaseZombie):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            animations = ZM.IMAGE['zombie']['1'],

            size = 25,
            color = (20, 140, 99),
            speed = LM.enemy_config['Zombie_1']['speed'],
            health = LM.enemy_config['Zombie_1']['health'],
            WIDTH = ZM.WIDTH,
            Zom_x = ZM.Zom_x,
            Zom_y = ZM.Zom_y,
            GAME_HEIGHT = ZM.GAME_HEIGHT
        )

        self.window_damage = LM.enemy_config['Zombie_1']['window_damage']
        self.bullet_damage = LM.enemy_config['Zombie_1']['bullet_damage']
...
class Zombie_2(BaseZombie):
    ...
    def __init__(self):
        ...
        super().__init__(
            size = ZM.GRID,
            animations = ZM.IMAGE['zombie']['2'],
            color = (50, 145, 113),
            speed = LM.enemy_config['Zombie_2']['speed'],
            health = LM.enemy_config['Zombie_2']['health'],
            WIDTH = ZM.WIDTH,
            Zom_x = ZM.Zom_x,
            Zom_y = ZM.Zom_y,
            GAME_HEIGHT = ZM.GAME_HEIGHT
        )
        self.window_damage = LM.enemy_config['Zombie_2']['window_damage']
        self.bullet_damage = LM.enemy_config['Zombie_2']['bullet_damage']
...
class Zombie_3(BaseZombie):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            size = ZM.GRID,
            color=(50, 145, 99),
            speed = LM.enemy_config['Zombie_3']['speed'],
            health = LM.enemy_config['Zombie_3']['health']
        )
        self.window_damage = LM.enemy_config['Zombie_3']['window_damage']
        self.bullet_damage = LM.enemy_config['Zombie_3']['bullet_damage']
...
class Zombie_4(BaseZombie):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            size = ZM.GRID,
            color=(50, 145, 99),
            speed = LM.enemy_config['Zombie_4']['speed'],
            health = LM.enemy_config['Zombie_4']['health']
        )
        self.window_damage = LM.enemy_config['Zombie_4']['window_damage']
        self.bullet_damage = LM.enemy_config['Zombie_4']['bullet_damage']
